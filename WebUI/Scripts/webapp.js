...
$(document).ready(function () {
    ...
    $('.form-control-number').kendoNumericTextBox({
        max: 1000000000000000000,
        decimals: 2,
        format: 'n2',
    });

    $('.form-control-numbern4').kendoNumericTextBox({
        max: 1000000000000000000,
        decimals: 4,
        format: 'n4',
    });
    ...
    //enable atau disable tombol submit pada saat client side validation
    $('.form-horizontal input').on('keyup blur', function () { // fires on every keyup & blur
        if ($('.form-horizontal').valid()) {                   // checks form for validity
