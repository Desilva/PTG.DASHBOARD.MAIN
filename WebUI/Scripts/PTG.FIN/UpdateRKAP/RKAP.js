...
function upload() {
    ...
    url = urlAction("UpdateData", "RKAP", "Upload");
...
function upload150() {
    ...
    pos = -140 - top;
    kendo.ui.progress($("#formWindow"), true);
    url = urlAction("UpdateData", "RKAP150", "Upload");
...
function download() {
    var url = urlAction("UpdateData", "RKAP", "Download");
    var year = $("#Year").val();
    window.location.href = url + "?Year=" + year;
}

function download150() {
    var url = urlAction("UpdateData", "RKAP150", "Download");
    var year = $("#Year").val();
    window.location.href = url + "?Year=" + year;
}
...
function setValidator() {
    $.validator.unobtrusive.parse("#rkapForm");
    $("#rkapForm").data("validator").settings.ignore = ":hidden:not(.validateAlways)";
...
function setValidator150() {
    $.validator.unobtrusive.parse("#rkap150Form");
    $("#rkap150Form").data("validator").settings.ignore = ":hidden:not(.validateAlways)";

    $("input").on("keyup blur", function () {
        if ($("#rkap150Form").valid()) {
            $("button[type=submit]").prop("disabled", false);
        } else {
            $("button[type=submit]").prop("disabled", "disabled");
        }
